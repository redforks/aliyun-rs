...
impl SendCardSms {
    pub fn new(
        card_objects: impl Into<Vec<Object>>,
        sign_name: impl Into<String>,
...
impl crate::FlatSerialize for O {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
impl crate::FlatSerialize for Object {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
impl crate::FlatSerialize for Record {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
impl crate::FlatSerialize for ResourcesTagResource {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct ResponseTagResource {
    #[serde(rename = "TagResource")]
    pub tag_resource: Vec<ResourcesTagResource>,
}

impl crate::FlatSerialize for ResponseTagResource {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
pub struct ListTagResourcesResponse {
    ...
    pub tag_resources: ResponseTagResource,
}
