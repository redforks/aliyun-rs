...
pub struct RecognizeAllText {
    ...
    #[setters(generate = true, strip_option)]
    advanced_config: Option<RecognizeAllTextAdvancedConfig>,
    /// * 当图片类型为身份证时（**Type=IdCard**），可通过本字段设置可选功能。
    #[setters(generate = true, strip_option)]
    id_card_config: Option<RecognizeAllTextIdCardConfig>,
    /// * 当图片类型为国际身份证时（Type=**InternationalIdCard**），可通过本字段设置可选功能。
    #[setters(generate = true, strip_option)]
    international_id_card_config: Option<RecognizeAllTextInternationalIdCardConfig>,
    /// * 当图片类型为国际企业执照时（Type=**InternationalBusinessLicense**），可通过本字段设置可选功能。
    #[setters(generate = true, strip_option)]
    international_business_license_config:
        Option<RecognizeAllTextInternationalBusinessLicenseConfig>,
    /// * 当图片类型为通用多语言文字时（Type=**MultiLang**），可通过本字段设置可选功能。
    #[setters(generate = true, strip_option)]
    multi_lan_config: Option<RecognizeAllTextMultiLanConfig>,
    /// * 当图片类型为表格时（Type=**Table**），可通过本字段设置可选功能。
    #[setters(generate = true, strip_option)]
    table_config: Option<RecognizeAllTextTableConfig>,
}

impl sealed::Bound for RecognizeAllText {}

impl RecognizeAllText {
    pub fn new(r#type: impl Into<RecognizeAllTextType>) -> Self {
        Self {
            url: None,
            body: None,
            r#type: r#type.into(),
...
pub struct RecognizeTableOcr {
    ...
    /// * 注意：该字段是字符串类型。
    #[setters(generate = true, strip_option)]
    is_hand_writing: Option<RecognizeTableOcrIsHandWriting>,
}
...
pub struct RecognizeInternationalIdcard {
    ...
    country: RecognizeInternationalIdcardCountry,
}

impl sealed::Bound for RecognizeInternationalIdcard {}

impl RecognizeInternationalIdcard {
    pub fn new(country: impl Into<RecognizeInternationalIdcardCountry>) -> Self {
        Self {
            url: None,
            body: None,
...
pub struct RecognizeInternationalBusinessLicense {
    ...
    body: Option<Vec<u8>>,
    /// 国家名称
    country: RecognizeInternationalBusinessLicenseCountry,
}

impl sealed::Bound for RecognizeInternationalBusinessLicense {}

impl RecognizeInternationalBusinessLicense {
    pub fn new(country: impl Into<RecognizeInternationalBusinessLicenseCountry>) -> Self {
        Self {
            url: None,
            body: None,
            country: country.into(),
...
#[serde(default)]
pub struct RecognizeAllTextAdvancedConfig {
...
impl crate::FlatSerialize for RecognizeAllTextAdvancedConfig {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextIdCardConfig {
...
impl crate::FlatSerialize for RecognizeAllTextIdCardConfig {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextInternationalBusinessLicenseConfig {
    #[serde(rename = "Country")]
    pub country: String,
}

impl crate::FlatSerialize for RecognizeAllTextInternationalBusinessLicenseConfig {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextInternationalIdCardConfig {
    #[serde(rename = "Country")]
    pub country: RecognizeAllTextInternationalIdCardConfigCountry,
}

impl crate::FlatSerialize for RecognizeAllTextInternationalIdCardConfig {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextMultiLanConfig {
    #[serde(rename = "Languages")]
    pub languages: String,
}

impl crate::FlatSerialize for RecognizeAllTextMultiLanConfig {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseData {
    ...
    pub sub_images: Vec<RecognizeAllTextResponseDataSubImagesItem>,
    #[serde(rename = "Width")]
    pub width: i32,
...
impl crate::FlatSerialize for RecognizeAllTextResponseData {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItem {
    #[serde(rename = "Angle")]
    pub angle: i32,
    #[serde(rename = "BarCodeInfo")]
    pub bar_code_info: RecognizeAllTextResponseDataSubImagesItemBarCodeInfo,
    #[serde(rename = "BlockInfo")]
    pub block_info: RecognizeAllTextResponseDataSubImagesItemBlockInfo,
    #[serde(rename = "FigureInfo")]
    pub figure_info: RecognizeAllTextResponseDataSubImagesItemFigureInfo,
    #[serde(rename = "KvInfo")]
    pub kv_info: RecognizeAllTextResponseDataSubImagesItemKvInfo,
    #[serde(rename = "ParagraphInfo")]
    pub paragraph_info: RecognizeAllTextResponseDataSubImagesItemParagraphInfo,
    #[serde(rename = "QrCodeInfo")]
    pub qr_code_info: RecognizeAllTextResponseDataSubImagesItemQrCodeInfo,
    #[serde(rename = "QualityInfo")]
    pub quality_info: RecognizeAllTextResponseDataSubImagesItemQualityInfo,
    #[serde(rename = "RowInfo")]
    pub row_info: RecognizeAllTextResponseDataSubImagesItemRowInfo,
    #[serde(rename = "StampInfo")]
    pub stamp_info: RecognizeAllTextResponseDataSubImagesItemStampInfo,
    #[serde(rename = "SubImageId")]
    pub sub_image_id: i32,
    #[serde(rename = "SubImagePoints")]
    pub sub_image_points: Vec<RecognizeAllTextResponseDataSubImagesItemSubImagePointsItem>,
    #[serde(rename = "SubImageRect")]
    pub sub_image_rect: RecognizeAllTextResponseDataSubImagesItemSubImageRect,
    #[serde(rename = "TableInfo")]
    pub table_info: RecognizeAllTextResponseDataSubImagesItemTableInfo,
    #[serde(rename = "Type")]
    pub r#type: String,
}

impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItem {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemBarCodeInfo {
    #[serde(rename = "BarCodeCount")]
    pub bar_code_count: i32,
    #[serde(rename = "BarCodeDetails")]
    pub bar_code_details:
        Vec<RecognizeAllTextResponseDataSubImagesItemBarCodeInfoBarCodeDetailsItem>,
}

impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemBarCodeInfo {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemBarCodeInfoBarCodeDetailsItem {
    #[serde(rename = "BarCodeAngle")]
    pub bar_code_angle: i32,
    #[serde(rename = "BarCodePoints")]
    pub bar_code_points: Vec<
        RecognizeAllTextResponseDataSubImagesItemBarCodeInfoBarCodeDetailsItemBarCodePointsItem,
    >,
    #[serde(rename = "BarCodeRect")]
    pub bar_code_rect:
        RecognizeAllTextResponseDataSubImagesItemBarCodeInfoBarCodeDetailsItemBarCodeRect,
    #[serde(rename = "Data")]
    pub data: String,
    #[serde(rename = "Type")]
    pub r#type: String,
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemBarCodeInfoBarCodeDetailsItem
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemBarCodeInfoBarCodeDetailsItemBarCodePointsItem {
    #[serde(rename = "X")]
    pub x: i32,
    #[serde(rename = "Y")]
    pub y: i32,
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemBarCodeInfoBarCodeDetailsItemBarCodePointsItem
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemBarCodeInfoBarCodeDetailsItemBarCodeRect {
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemBarCodeInfoBarCodeDetailsItemBarCodeRect
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemBlockInfo {
    #[serde(rename = "BlockCount")]
    pub block_count: i32,
    #[serde(rename = "BlockDetails")]
    pub block_details: Vec<RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItem>,
}

impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemBlockInfo {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItem {
    ...
    pub block_points:
        Vec<RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemBlockPointsItem>,
    #[serde(rename = "BlockRect")]
    pub block_rect: RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemBlockRect,
    #[serde(rename = "CharInfos")]
    pub char_infos:
        Vec<RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemCharInfosItem>,
}

impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItem {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemBlockPointsItem {
    #[serde(rename = "X")]
    pub x: i32,
    #[serde(rename = "Y")]
    pub y: i32,
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemBlockPointsItem
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemBlockRect {
    #[serde(rename = "CenterX")]
    pub center_x: i32,
    #[serde(rename = "CenterY")]
    pub center_y: i32,
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemBlockRect
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemCharInfosItem {
    ...
    pub char_points: Vec<RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemCharInfosItemCharPointsItem>,
    #[serde(rename = "CharRect")]
    pub char_rect: RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemCharInfosItemCharRect,
}

impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemCharInfosItem
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemCharInfosItemCharPointsItem
{
    #[serde(rename = "X")]
    pub x: i32,
    #[serde(rename = "Y")]
...
impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemCharInfosItemCharPointsItem {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemCharInfosItemCharRect {
    #[serde(rename = "CenterX")]
    pub center_x: i32,
    #[serde(rename = "CenterY")]
    pub center_y: i32,
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemBlockInfoBlockDetailsItemCharInfosItemCharRect
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemFigureInfo {
    /// Additional properties not explicitly defined in the schema
    #[serde(flatten)]
    pub extra: std::collections::HashMap<String, crate::Value>,
}

impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemFigureInfo {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemKvInfo {
    #[serde(rename = "Data")]
    pub data: String,
    #[serde(rename = "KvCount")]
    pub kv_count: i32,
    #[serde(rename = "KvDetails")]
    pub kv_details: RecognizeAllTextResponseDataSubImagesItemKvInfoKvDetails,
}

impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemKvInfo {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemKvInfoKvDetails {
    /// Additional properties not explicitly defined in the schema
    #[serde(flatten)]
    pub extra: std::collections::HashMap<String, crate::Value>,
}

impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemKvInfoKvDetails {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemParagraphInfo {
    #[serde(rename = "ParagraphCount")]
    pub paragraph_count: i32,
    #[serde(rename = "ParagraphDetails")]
    pub paragraph_details:
        Vec<RecognizeAllTextResponseDataSubImagesItemParagraphInfoParagraphDetailsItem>,
}

impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemParagraphInfo {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemParagraphInfoParagraphDetailsItem {
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemParagraphInfoParagraphDetailsItem
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemQrCodeInfo {
    #[serde(rename = "QrCodeCount")]
    pub qr_code_count: i32,
    #[serde(rename = "QrCodeDetails")]
    pub qr_code_details: Vec<RecognizeAllTextResponseDataSubImagesItemQrCodeInfoQrCodeDetailsItem>,
}

impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemQrCodeInfo {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemQrCodeInfoQrCodeDetailsItem {
    #[serde(rename = "Data")]
    pub data: String,
    ...
    pub qr_code_points:
        Vec<RecognizeAllTextResponseDataSubImagesItemQrCodeInfoQrCodeDetailsItemQrCodePointsItem>,
    #[serde(rename = "QrCodeRect")]
    pub qr_code_rect:
        RecognizeAllTextResponseDataSubImagesItemQrCodeInfoQrCodeDetailsItemQrCodeRect,
}

impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemQrCodeInfoQrCodeDetailsItem {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemQrCodeInfoQrCodeDetailsItemQrCodePointsItem {
    #[serde(rename = "X")]
    pub x: i32,
    #[serde(rename = "Y")]
    pub y: i32,
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemQrCodeInfoQrCodeDetailsItemQrCodePointsItem
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemQrCodeInfoQrCodeDetailsItemQrCodeRect {
    #[serde(rename = "CenterX")]
    pub center_x: i32,
    #[serde(rename = "CenterY")]
    pub center_y: i32,
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemQrCodeInfoQrCodeDetailsItemQrCodeRect
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemQualityInfo {
...
impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemQualityInfo {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemRowInfo {
    #[serde(rename = "RowCount")]
    pub row_count: i32,
    #[serde(rename = "RowDetails")]
    pub row_details: Vec<RecognizeAllTextResponseDataSubImagesItemRowInfoRowDetailsItem>,
}

impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemRowInfo {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemRowInfoRowDetailsItem {
    #[serde(rename = "BlockList")]
    pub block_list: Vec<i32>,
...
impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemRowInfoRowDetailsItem {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemStampInfo {
    #[serde(rename = "StampCount")]
    pub stamp_count: i32,
    #[serde(rename = "StampDetails")]
    pub stamp_details: Vec<RecognizeAllTextResponseDataSubImagesItemStampInfoStampDetailsItem>,
}

impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemStampInfo {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemStampInfoStampDetailsItem {
    #[serde(rename = "Data")]
    pub data: RecognizeAllTextResponseDataSubImagesItemStampInfoStampDetailsItemData,
    #[serde(rename = "StampAngle")]
    pub stamp_angle: i32,
    #[serde(rename = "StampPoints")]
    pub stamp_points:
        Vec<RecognizeAllTextResponseDataSubImagesItemStampInfoStampDetailsItemStampPointsItem>,
    #[serde(rename = "StampRect")]
    pub stamp_rect: RecognizeAllTextResponseDataSubImagesItemStampInfoStampDetailsItemStampRect,
}

impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemStampInfoStampDetailsItem {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemStampInfoStampDetailsItemData {
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemStampInfoStampDetailsItemData
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemStampInfoStampDetailsItemStampPointsItem {
    #[serde(rename = "X")]
    pub x: i32,
    #[serde(rename = "Y")]
    pub y: i32,
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemStampInfoStampDetailsItemStampPointsItem
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemStampInfoStampDetailsItemStampRect {
    #[serde(rename = "CenterX")]
    pub center_x: i32,
    #[serde(rename = "CenterY")]
    pub center_y: i32,
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemStampInfoStampDetailsItemStampRect
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemSubImagePointsItem {
    #[serde(rename = "X")]
    pub x: i32,
    #[serde(rename = "Y")]
    pub y: i32,
...
impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemSubImagePointsItem {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemSubImageRect {
    #[serde(rename = "CenterX")]
    pub center_x: i32,
    #[serde(rename = "CenterY")]
    pub center_y: i32,
...
impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemSubImageRect {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemTableInfo {
    #[serde(rename = "TableCount")]
    pub table_count: i32,
    #[serde(rename = "TableDetails")]
    pub table_details: Vec<RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItem>,
...
impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemTableInfo {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItem {
    #[serde(rename = "CellCount")]
    pub cell_count: i32,
    #[serde(rename = "CellDetails")]
    pub cell_details:
        Vec<RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemCellDetailsItem>,
    #[serde(rename = "ColumnCount")]
    pub column_count: i32,
    #[serde(rename = "Footer")]
    pub footer: RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemFooter,
    #[serde(rename = "Header")]
    pub header: RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemHeader,
    #[serde(rename = "RowCount")]
    pub row_count: i32,
    ...
    pub table_points:
        Vec<RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemTablePointsItem>,
    #[serde(rename = "TableRect")]
    pub table_rect: RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemTableRect,
}

impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItem {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemCellDetailsItem {
    #[serde(rename = "BlockList")]
    pub block_list: Vec<i32>,
    ...
    pub cell_points: Vec<RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemCellDetailsItemCellPointsItem>,
    #[serde(rename = "CellRect")]
    pub cell_rect: RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemCellDetailsItemCellRect,
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemCellDetailsItem
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemCellDetailsItemCellPointsItem
{
    #[serde(rename = "X")]
    pub x: i32,
    #[serde(rename = "Y")]
...
impl crate::FlatSerialize for RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemCellDetailsItemCellPointsItem {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<std::borrow::Cow<'static, str>, crate::QueryValue<'a>>,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemCellDetailsItemCellRect
{
    #[serde(rename = "CenterX")]
    pub center_x: i32,
    #[serde(rename = "CenterY")]
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemCellDetailsItemCellRect
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemFooter {
    #[serde(rename = "BlockId")]
    pub block_id: i32,
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemFooter
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemHeader {
    #[serde(rename = "BlockId")]
    pub block_id: i32,
    #[serde(rename = "Contents")]
    pub contents: Vec<String>,
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemHeader
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemTablePointsItem {
    #[serde(rename = "X")]
    pub x: i32,
    #[serde(rename = "Y")]
    pub y: i32,
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemTablePointsItem
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemTableRect {
    #[serde(rename = "CenterX")]
    pub center_x: i32,
    #[serde(rename = "CenterY")]
    pub center_y: i32,
...
impl crate::FlatSerialize
    for RecognizeAllTextResponseDataSubImagesItemTableInfoTableDetailsItemTableRect
{
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeAllTextTableConfig {
    #[serde(rename = "IsHandWritingTable")]
    pub is_hand_writing_table: bool,
    #[serde(rename = "IsLineLessTable")]
    pub is_line_less_table: bool,
...
impl crate::FlatSerialize for RecognizeAllTextTableConfig {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeGeneralStructureResponseData {
    #[serde(rename = "Height")]
    pub height: i32,
    #[serde(rename = "SubImageCount")]
    pub sub_image_count: i32,
    #[serde(rename = "SubImages")]
    pub sub_images: Vec<RecognizeGeneralStructureResponseDataSubImagesItem>,
    #[serde(rename = "Width")]
    pub width: i32,
}

impl crate::FlatSerialize for RecognizeGeneralStructureResponseData {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeGeneralStructureResponseDataSubImagesItem {
    #[serde(rename = "Angle")]
    pub angle: i32,
    #[serde(rename = "KvInfo")]
    pub kv_info: RecognizeGeneralStructureResponseDataSubImagesItemKvInfo,
    #[serde(rename = "SubImageId")]
    pub sub_image_id: i32,
}

impl crate::FlatSerialize for RecognizeGeneralStructureResponseDataSubImagesItem {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct RecognizeGeneralStructureResponseDataSubImagesItemKvInfo {
    #[serde(rename = "Data")]
    pub data: String,
    #[serde(rename = "KvCount")]
    pub kv_count: i32,
...
impl crate::FlatSerialize for RecognizeGeneralStructureResponseDataSubImagesItemKvInfo {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
pub enum RecognizeAllTextInternationalIdCardConfigCountry {
    #[serde(rename = "India")]
    India,
    #[serde(rename = "Korea")]
    Korea,
...
impl Default for RecognizeAllTextInternationalIdCardConfigCountry {
    fn default() -> Self {
        Self::India
    }
}

impl RecognizeAllTextInternationalIdCardConfigCountry {
...
impl<'a> From<&'a RecognizeAllTextInternationalIdCardConfigCountry> for crate::QueryValue<'a> {
    fn from(value: &'a RecognizeAllTextInternationalIdCardConfigCountry) -> Self {
        crate::QueryValue::from(value.as_str())
    }
}

impl crate::FlatSerialize for RecognizeAllTextInternationalIdCardConfigCountry {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
impl Default for RecognizeAllTextType {
    fn default() -> Self {
        Self::Advanced
    }
}

impl RecognizeAllTextType {
    /// Returns the string value of this enum variant as used in the API.
    pub fn as_str(&self) -> &'static str {
        match self {
...
impl<'a> From<&'a RecognizeAllTextType> for crate::QueryValue<'a> {
    fn from(value: &'a RecognizeAllTextType) -> Self {
        crate::QueryValue::from(value.as_str())
    }
}

impl crate::FlatSerialize for RecognizeAllTextType {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
/// Enum type marshalled as String
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
pub enum RecognizeInternationalBusinessLicenseCountry {
    #[serde(rename = "India")]
    India,
    #[serde(rename = "Korea")]
    Korea,
...
impl Default for RecognizeInternationalBusinessLicenseCountry {
    fn default() -> Self {
        Self::India
    }
}

impl RecognizeInternationalBusinessLicenseCountry {
    /// Returns the string value of this enum variant as used in the API.
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::India => "India",
...
impl<'a> From<&'a RecognizeInternationalBusinessLicenseCountry> for crate::QueryValue<'a> {
    fn from(value: &'a RecognizeInternationalBusinessLicenseCountry) -> Self {
        crate::QueryValue::from(value.as_str())
    }
}

impl crate::FlatSerialize for RecognizeInternationalBusinessLicenseCountry {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
/// Enum type marshalled as String
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
pub enum RecognizeInternationalIdcardCountry {
    /// India
    #[serde(rename = "India")]
    India,
    /// Vietnam
...
impl Default for RecognizeInternationalIdcardCountry {
    fn default() -> Self {
        Self::India
    }
}

impl RecognizeInternationalIdcardCountry {
    /// Returns the string value of this enum variant as used in the API.
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::India => "India",
...
impl<'a> From<&'a RecognizeInternationalIdcardCountry> for crate::QueryValue<'a> {
    fn from(value: &'a RecognizeInternationalIdcardCountry) -> Self {
        crate::QueryValue::from(value.as_str())
    }
}

impl crate::FlatSerialize for RecognizeInternationalIdcardCountry {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
/// Enum type marshalled as String
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
pub enum RecognizeTableOcrIsHandWriting {
    #[serde(rename = "true")]
    True,
    #[serde(rename = "false")]
    False,
...
impl Default for RecognizeTableOcrIsHandWriting {
    fn default() -> Self {
        Self::True
    }
}

impl RecognizeTableOcrIsHandWriting {
    /// Returns the string value of this enum variant as used in the API.
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::True => "true",
...
impl<'a> From<&'a RecognizeTableOcrIsHandWriting> for crate::QueryValue<'a> {
    fn from(value: &'a RecognizeTableOcrIsHandWriting) -> Self {
        crate::QueryValue::from(value.as_str())
    }
}

impl crate::FlatSerialize for RecognizeTableOcrIsHandWriting {
    fn flat_serialize<'a>(
        &'a self,
        name: &str,
        params: &mut std::collections::BTreeMap<
...
pub struct RecognizeAllTextResponse {
    ...
    #[serde(rename = "Data")]
    pub data: RecognizeAllTextResponseData,
...
pub struct RecognizeGeneralStructureResponse {
    ...
    pub code_message: crate::CodeMessage,
    #[serde(rename = "Data")]
    pub data: RecognizeGeneralStructureResponseData,
    #[serde(rename = "RequestId")]
    pub request_id: String,
}
