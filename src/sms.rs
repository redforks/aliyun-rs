...
impl crate::Request for SubmitSmsQualification {
    ...
    fn to_query_params(
        ...
        params.insert("OtherFiles", (&self.other_files).into());
...
impl crate::Request for QuerySmsQualificationRecord {
    ...
    fn to_query_params(
        ...
        params.insert("LegalPersonName", (&self.legal_person_name).into());
        params.insert("UseBySelf", (&self.use_by_self).into());
        params.insert("PageNo", (&self.page_no).into());
...
impl crate::Request for QuerySmsAuthorizationLetter {
    ...
    fn to_query_params(
        ...
        params.insert("OrganizationCode", (&self.organization_code).into());
        params.insert("State", (&self.state).into());
        params.insert("Status", (&self.status).into());
        Ok(params)
    }
...
impl crate::Request for CreateSmsSign {
    ...
    fn to_query_params(
        ...
        params.insert("SignName", (&self.sign_name).into());
        params.insert("Remark", (&self.remark).into());
        params.insert("SignType", (&self.sign_type).into());
        params.insert("MoreData", (&self.more_data).into());
...
impl crate::Request for CreateSmsTemplate {
    ...
    fn to_query_params(
        ...
        params.insert("RelatedSignName", (&self.related_sign_name).into());
        params.insert("TemplateRule", (&self.template_rule).into());
        params.insert("MoreData", (&self.more_data).into());
        params.insert("ApplySceneContent", (&self.apply_scene_content).into());
        params.insert("IntlType", (&self.intl_type).into());
        params.insert("TrafficDriving", (&self.traffic_driving).into());
        Ok(params)
    }
...
impl crate::Request for GetMediaResourceId {
    ...
    fn to_query_params(
        ...
        params.insert("ExtendInfo", (&self.extend_info).into());
        params.insert("Memo", (&self.memo).into());
        Ok(params)
    }
...
impl crate::Request for CreateCardSmsTemplate {
    ...
    fn to_query_params(
        ...
        params.insert("Memo", (&self.memo).into());
        params.insert("Factorys", (&self.factorys).into());
        Ok(params)
    }
...
impl crate::Request for QueryMobilesCardSupport {
    ...
    fn to_query_params(
        ...
        params.insert("TemplateCode", (&self.template_code).into());
        params.insert("Mobiles", (&self.mobiles).into());
        params.insert("EncryptType", (&self.encrypt_type).into());
        Ok(params)
    }
...
impl crate::Request for GetCardSmsLink {
    ...
    fn to_query_params(
        ...
        params.insert("Domain", (&self.domain).into());
        params.insert("CustomShortCodeJson", (&self.custom_short_code_json).into());
        Ok(params)
    }
...
impl crate::Request for GetCardSmsDetails {
    ...
    fn to_query_params(
        ...
        params.insert("SendDate", (&self.send_date).into());
        params.insert("PhoneNumber", (&self.phone_number).into());
        params.insert("BizCardId", (&self.biz_card_id).into());
        params.insert("BizSmsId", (&self.biz_sms_id).into());
        params.insert("BizDigitId", (&self.biz_digit_id).into());
        Ok(params)
    }
...
impl crate::Request for SmsConversionIntl {
    ...
    fn to_query_params(
        ...
        params.insert("ConversionTime", (&self.conversion_time).into());
        Ok(params)
    }
...
impl crate::Request for ListTagResources {
    ...
    fn to_query_params(
        ...
        params.insert("NextToken", (&self.next_token).into());
        params.insert("PageSize", (&self.page_size).into());
        params.insert("ProdCode", (&self.prod_code).into());
        params.insert("Tag", (&self.tag).into());
        params.insert("ResourceId", (&self.resource_id).into());
        Ok(params)
    }
...
impl crate::Request for UntagResources {
    ...
    fn to_query_params(
        ...
        params.insert("ResourceType", (&self.resource_type).into());
        params.insert("RegionId", (&self.region_id).into());
        params.insert("All", (&self.all).into());
        params.insert("ProdCode", (&self.prod_code).into());
        params.insert("TagKey", (&self.tag_key).into());
        params.insert("ResourceId", (&self.resource_id).into());
        Ok(params)
    }
