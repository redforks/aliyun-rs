    ...
    fn to_query_params(&self) -> crate::Result<std::collections::BTreeMap<&'static str, crate::QueryValue<'_>>> {
        let mut params = std::collections::BTreeMap::new();
            ...
            if let Some(f) = self.business_license_pics {
                params.insert("BusinessLicensePics", f.into());
            }
            ...
            if let Some(f) = self.other_files {
                params.insert("OtherFiles", f.into());
            }
    ...
    fn to_query_params(&self) -> crate::Result<std::collections::BTreeMap<&'static str, crate::QueryValue<'_>>> {
        let mut params = std::collections::BTreeMap::new();
            if let Some(f) = self.authorization_letter_id_list {
                params.insert("AuthorizationLetterIdList", f.into());
            }
...
impl CreateCardSmsTemplate {
    pub fn new(template_name: impl Into<String>, template: impl Into<std::collections::HashMap<String, String>>) -> Self {
        Self {
            template_name: template_name.into(),
...
impl CheckMobilesCardSupport {
    pub fn new(template_code: impl Into<String>, mobiles: impl Into<Vec<std::collections::HashMap<String, String>>>) -> Self {
        Self {
            template_code: template_code.into(),
...
impl SendCardSms {
    pub fn new(card_objects: impl Into<Vec<std::collections::HashMap<String, String>>>, sign_name: impl Into<String>, card_template_code: impl Into<String>, fallback_type: impl Into<String>) -> Self {
        Self {
    ...
    fn to_query_params(&self) -> crate::Result<std::collections::BTreeMap<&'static str, crate::QueryValue<'_>>> {
        let mut params = std::collections::BTreeMap::new();
            ...
            if let Some(f) = self.tag {
                params.insert("Tag", f.into());
            }
        
            if let Some(f) = self.resource_id {
                params.insert("ResourceId", f.into());
            }
...
impl TagResources {
    pub fn new(resource_type: impl Into<String>, region_id: impl Into<String>, tag: impl Into<Vec<std::collections::HashMap<String, String>>>) -> Self {
        Self {
            resource_type: resource_type.into(),
            region_id: region_id.into(),
            prod_code: None,
